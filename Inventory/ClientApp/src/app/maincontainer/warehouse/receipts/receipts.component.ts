...
export class ReceiptsComponent implements OnInit {
  ...
  scolumns: string[] = ['number', 'createdate', 'items'];
  displayedColumns: string[] = ['action', ...this.scolumns];

  container: ReceiptListModel[] = [];
  etalon: ReceiptListModel[] = [];
  public ds = new MatTableDataSource<ReceiptListModel>();
  ...
  filterItems() {
    ...
    if (this.selectednumbers.length === 0 && this.selectednames.length === 0 && this.selectedunitnames.length === 0) {
